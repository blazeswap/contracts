...
describe('BlazeSwapRouter', () => {
  ...
  describe('swapExactTokensForTokens', () => {
    ...
    it('gas', async () => {
      ...
      expect(receipt.gasUsed).to.be.within(107100, 107200)
    })
  })
  ...
  describe('swapTokensForExactTokens', () => {
    ...
    it('gas', async () => {
      ...
      const receipt = await tx.wait()
      expect(receipt.gasUsed).to.be.within(107550, 107650)
    })
  })
  ...
  describe('swapExactNATForTokens', () => {
    ...
    it('gas', async () => {
      ...
      const receipt = await tx.wait()
      expect(receipt.gasUsed).to.be.within(209000, 210000)
    })
  })
  ...
  describe('swapTokensForExactNAT', () => {
    ...
    it('gas', async () => {
      ...
      const receipt = await tx.wait()
      expect(receipt.gasUsed).to.be.within(309100, 309200)
    })
  })
  ...
  describe('swapExactTokensForNAT', () => {
    ...
    it('gas', async () => {
      ...
      const receipt = await tx.wait()
      expect(receipt.gasUsed).to.be.within(307025, 307125)
    })
  })
  ...
  describe('swapNATForExactTokens', () => {
    ...
    it('gas', async () => {
      ...
      const receipt = await tx.wait()
      expect(receipt.gasUsed).to.be.within(243600, 243700)
    })
  })
